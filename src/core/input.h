...
void get_userInput(std::string, int &, int = 0); // if the last integer is not provided, it is set to be 0
void get_userInput(std::string, int, int *&, int = 0); // if the last integer is not provided, it is set to be 0
void get_userInput(std::string, double &, int = 0); // if the last integer is not provided, it is set to be 0
void get_userInput(std::string, int, double *&, int = 0); // if the last integer is not provided, it is set to be 0
void get_userInput(std::string, std::string &, int = 0); // if the last integer is not provided, it is set to be 0
void get_userInput(std::string, int, std::vector<std::string> &, int = 0); // if the last integer is not provided, it is set to be 0
//
void get_userInput(std::string, std::string, int &, int = 0); // if the last integer is not provided, it is set to be 0
void get_userInput(std::string, std::string, int, int *&, int = 0); // if the last integer is not provided, it is set to be 0
void get_userInput(std::string, std::string, double &, int = 0); // if the last integer is not provided, it is set to be 0
void get_userInput(std::string, std::string, int, double *&, int = 0); // if the last integer is not provided, it is set to be 0
void get_userInput(std::string, std::string, std::string &, int = 0); // if the last integer is not provided, it is set to be 0
void get_userInput(std::string, std::string, int, std::vector<std::string> &, int = 0); // if the last integer is not provided, it is set to be 0
