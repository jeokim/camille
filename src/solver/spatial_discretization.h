...
void compute_RHS_linearizedEuler(UserInput *, Geometry::StructuredGrid *, State *, double **, double **);
void compute_RHS_linearizedEuler_scalar(UserInput *, Geometry::StructuredGrid *, State *, double **, double **);
