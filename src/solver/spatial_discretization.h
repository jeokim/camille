...
void compute_RHS_LEE(UserInput *, Geometry::StructuredGrid *, State *, double **, double **);
void compute_RHS_LEE_scalar(UserInput *, Geometry::StructuredGrid *, State *, double **, double **);
